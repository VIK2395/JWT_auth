__Open Authorization(OAuth2.0) && OpenID Connect(OIDC) && Single Sign-On(SSO)__
...
such as an email provider or social network, __to authenticate their identities__.
